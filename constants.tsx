...
export const CHALLENGES_LIST = [
  ...
  "هل تشعر أنك قادر على النجاح لكنك تحتاج لمن يوجهك بالطريقة الصحيحة؟",
...
export const STEPS_LIST = [
  ...
  "نبدأ الشرح والتدريب العملي (حضوري أو عن بعد حسب الرغبة) مع المتابعة المستمرة حتى ليلة الاختبار."
];